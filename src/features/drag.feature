...
Feature: Test draggable elements
    ...
    Background:
        ...
        And   I expect that element "#draggable" is positioned at 130.59375px on the y axis
        And   I expect that element "#droppable" is positioned at 130.59375px on the y axis
    ...
    Scenario: Drag to dropzone
        ...
        And   I expect that element "#draggable" is positioned at 180.59375px on the y axis
